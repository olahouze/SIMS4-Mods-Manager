...
from src.core.game_detector import GameDetector, LOCALIZED_SIMS4_FOLDERS
from src.utils.resource_cfg import ensure_resource_cfg, DEFAULT_RESOURCE_CFG_CONTENT
