...
class GameDetector:
    """Detects Sims 4 installation paths, Mods directory, and delegates executable detection."""
    ...
    def detect_game_executable(cls, custom_exe: Optional[str] = None) -> Optional[Path]:
        ...
        return GameLauncher.detect_game_executable(custom_exe)
    ...
    def start_background_detection_refresh(cls) -> None:
        ...
        def _worker():
            ...
            try:
                ...
                fresh_exe = GameLauncher._do_detect_game_executable()
                ...
                if fresh_exe and str(fresh_exe) != config.cached_game_exe:
                    ...
                    GameLauncher._cached_game_exe = fresh_exe
                    changed = True
